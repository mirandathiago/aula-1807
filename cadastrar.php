    ...
    <main class="container">
        ...
        <form class="container" action="cadastrar.php" method="post">
            ...
            <div class="coluna1">
                ...
                <input type="radio" id="tipoReceitas" name="tipo" value="receitas" onclick="populaCategorias()">
                <label for="tipoReceitas" class="radio-label receita"> <i class="ri-arrow-up-circle-fill"></i>Receitas</label>
                <input type="radio" id="tipoDespesas" name="tipo" value="despesas" onclick="populaCategorias()">
